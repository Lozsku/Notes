...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{    x1 }\OperatorTok{{-}{-}{-}{-}}\NormalTok{w1}\OperatorTok{{-}{-}{-}{-}\textbackslash{}}
                  \OperatorTok{\textbackslash{}}
\NormalTok{    x2 }\OperatorTok{{-}{-}{-}{-}}\NormalTok{w2}\OperatorTok{{-}{-}{-}{-}{-}}\NormalTok{[∑ }\OperatorTok{+}\NormalTok{ b]}\OperatorTok{{-}{-}{-}{-}}\NormalTok{[f(.)]}\OperatorTok{{-}{-}{-}{-}{-}\textgreater{}}\NormalTok{ y}
                  \OperatorTok{/}
\NormalTok{    x3 }\OperatorTok{{-}{-}{-}{-}}\NormalTok{w3}\OperatorTok{{-}{-}{-}{-}/}

\NormalTok{∑ }\OperatorTok{=}\NormalTok{ w1}\OperatorTok{*}\NormalTok{x1 }\OperatorTok{+}\NormalTok{ w2}\OperatorTok{*}\NormalTok{x2 }\OperatorTok{+}\NormalTok{ w3}\OperatorTok{*}\NormalTok{x3 }\OperatorTok{+}\NormalTok{ b   (linear combination)}
\NormalTok{f }\OperatorTok{=}\NormalTok{ activation function           (non}\OperatorTok{{-}}\NormalTok{linearity)}
\NormalTok{y }\OperatorTok{=}\NormalTok{ f(∑)                          (neuron output)}
\end{Highlighting}
\end{Shaded}
