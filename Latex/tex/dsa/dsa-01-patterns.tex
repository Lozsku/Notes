...
\visualfigure{../../figures/dsa-01-patterns/03-pattern-decision-tree.pdf}{Most coding-interview problems map to a small set of patterns. Read the input shape and the asked-for quantity, and this guide points you to the right tool.}
