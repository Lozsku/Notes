...
\subsubsection{What companies are actually buying}\label{what-companies-are-actually-buying}
...
\subsubsection{The bar-raiser model (Amazon) and calibrated loops (Google)}\label{the-bar-raiser-model-amazon-and-calibrated-loops-google}
...
\subsubsection{What gets screened out}\label{what-gets-screened-out}
...
\subsubsection{Amazon --- Leadership Principles \& Bar Raiser}\label{amazon--leadership-principles--bar-raiser}
...
\subsubsection{Google --- Googleyness \& Leadership}\label{google--googleyness--leadership}
...
\subsubsection{Meta --- "Move Fast, Be Direct"}\label{meta--move-fast-be-direct}
...
\subsubsection{Microsoft --- Growth Mindset}\label{microsoft--growth-mindset}
...
\subsubsection{How each company weights behavioral vs. technical}\label{how-each-company-weights-behavioral-vs-technical}
...
\subsection{The STAR Method}\label{the-star-method}
...
\subsubsection{The STAR principle}\label{the-star-principle}
...
\subsubsection{The Weak vs. Strong worked example}\label{the-weak-vs-strong-worked-example}
...
\subsubsection{STAR anti-patterns}\label{star-anti-patterns}
...
\subsection{Core Themes}\label{core-themes}
...
\subsubsection{Conflict Resolution}\label{conflict-resolution}
...
\subsubsection{Cross-team Collaboration}\label{cross-team-collaboration}
...
\subsubsection{Project Impact}\label{project-impact}
...
\subsection{Amazon\textquotesingle s 16 Leadership Principles}\label{amazons-16-leadership-principles}
...
\subsection{Building Your Story Bank}\label{building-your-story-bank}

\subsubsection{Why a story bank}\label{why-a-story-bank}
...
\subsubsection{The matrix template}\label{the-matrix-template}
...
\subsubsection{Story bank rules}\label{story-bank-rules}
...
\subsubsection{Story template (fill in for each story)}\label{story-template-fill-in-for-each-story}
...
\subsection{Architecture / Frameworks}\label{architecture--frameworks}

\subsubsection{STAR structure (ASCII)}\label{star-structure-ascii}
...
\subsubsection{Story matrix grid (themes vs. LPs)}\label{story-matrix-grid-themes-vs-lps}
...
\subsubsection{Scoring rubric (how interviewers actually score)}\label{scoring-rubric-how-interviewers-actually-score}
...
\subsection{Real-World Example Answers}\label{real-world-example-answers}

\subsubsection{Example 1: Conflict resolution}\label{example-1-conflict-resolution}
...
\subsubsection{Example 2: Failure}\label{example-2-failure}
...
\subsubsection{Example 3: Leadership / impact}\label{example-3-leadership--impact}
...
\subsubsection{Remembering STAR}\label{remembering-star}
...
\subsubsection{Remembering Amazon\textquotesingle s 16 LPs (grouped)}\label{remembering-amazons-16-lps-grouped}
...
\subsubsection{Remembering not to say "we"}\label{remembering-not-to-say-we}
...
\subsubsection{The 3-number rule for results}\label{the-3-number-rule-for-results}
...
\subsubsection{Pre-interview 5-minute mental warm-up}\label{pre-interview-5-minute-mental-warm-up}
...
\subsubsection{Failure / Learning}\label{failure--learning}
...
\subsubsection{Ambiguity}\label{ambiguity-1}
...
\subsubsection{Teamwork / Cross-team}\label{teamwork--cross-team}
...
\subsection{Senior/Staff-Level Discussion Points}\label{seniorstaff-level-discussion-points}

\subsubsection{Scope expectations by level}\label{scope-expectations-by-level}
...
\subsubsection{Influence without authority}\label{influence-without-authority}
...
\subsubsection{Driving org-level impact}\label{driving-org-level-impact}
...
\subsubsection{Handling disagreement with leadership}\label{handling-disagreement-with-leadership}
...
\subsubsection{For "influence up" stories at senior+ level}\label{for-influence-up-stories-at-senior-level}
...
\subsubsection{General FAANG tips}\label{general-faang-tips}
...
\subsubsection{Key points (top 10)}\label{key-points-top-10}
...
\subsubsection{Pre-interview checklist}\label{pre-interview-checklist}
...
\subsubsection{Most important concepts at a glance}\label{most-important-concepts-at-a-glance}
