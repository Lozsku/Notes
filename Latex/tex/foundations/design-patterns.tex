...
\item
  \textbf{Frameworks you use daily} --- Spring, React, the JDK, Django, Hibernate are \emph{built from} these patterns; understanding them lets you read framework source and debug "magic."
\end{itemize}
