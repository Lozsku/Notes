...
\visualfigure{../figures/05-system-design/04-kafka-partitions.pdf}{A topic is split into partitions for parallelism. Within a consumer group each partition is read by exactly one consumer; different groups read the same data independently.}
...
\visualfigure{../figures/05-system-design/03-caching-patterns.pdf}{The four write/read cache patterns trade freshness, latency and durability. Cache-aside is the default; write-through favours consistency; write-back favours write latency.}
