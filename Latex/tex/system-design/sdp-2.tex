...
\visualfigure{../../figures/sdp-2/02-ride-state-machine.pdf}{Modeling the ride as an explicit state machine makes valid transitions (and the events that trigger them) unambiguous — the backbone of the matching and trip services.}
