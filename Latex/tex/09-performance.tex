...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{P(}\BuiltInTok{all}\NormalTok{ N }\OperatorTok{\textless{}}\NormalTok{ x) }\OperatorTok{=}\NormalTok{ P(one }\OperatorTok{\textless{}}\NormalTok{ x)}\OperatorTok{\^{}}\NormalTok{N}
\OperatorTok{=\textgreater{}}\NormalTok{ P(}\BuiltInTok{max} \OperatorTok{\textgreater{}}\NormalTok{ x) }\OperatorTok{=} \DecValTok{1} \OperatorTok{{-}}\NormalTok{ (}\DecValTok{1} \OperatorTok{{-}}\NormalTok{ P(one }\OperatorTok{\textgreater{}}\NormalTok{ x))}\OperatorTok{\^{}}\NormalTok{N}
\end{Highlighting}
\end{Shaded}
