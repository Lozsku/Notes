...
\visualfigure{../figures/09-performance/04-flame-graph.pdf}{Width = time spent. A wide bar with little above it is a self-time hot spot. Find the widest plateau near the top and optimize that function first.}
...
\visualfigure{../figures/09-performance/03-latency-path.pdf}{End-to-end latency is a sum over hops. Instrument every hop, find the one dominating the budget, and optimize that — don't guess.}
