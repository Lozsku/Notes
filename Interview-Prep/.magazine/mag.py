...
CONFIGS = [
 ...
 # ---- AI / ML series ----
 dict(n=18, file="AI-ML/01-ml-fundamentals.md", out="AI-ML/ML-Fundamentals-Magazine.pdf",
   name="ML Fundamentals", acc="#6366f1", acc2="#8b5cf6",
   sub="Supervised to self-supervised, bias–variance, regularization and the metrics that separate signal from noise.",
   title_html="Machine Learning <span class='g'>Fundamentals</span>",
   tags=["Supervised vs Unsupervised","Bias–Variance","Overfitting","Regularization","Metrics","Cross-Validation","Gradient Descent"]),
 dict(n=19, file="AI-ML/02-classic-ml-algorithms.md", out="AI-ML/Classic-ML-Algorithms-Magazine.pdf",
   name="Classic ML Algorithms", acc="#0ea5e9", acc2="#06b6d4",
   sub="Regression, trees, boosting, SVMs and clustering — the workhorses that still win on tabular data.",
   title_html="Classic ML <span class='g'>Algorithms</span>",
   tags=["Regression","Decision Trees","Random Forest","XGBoost","SVM","k-Means","PCA","Ensembles"]),
 dict(n=20, file="AI-ML/03-deep-learning.md", out="AI-ML/Deep-Learning-Magazine.pdf",
   name="Deep Learning", acc="#ec4899", acc2="#f43f5e",
   sub="Neurons, backprop, optimizers, CNNs and RNNs — how machines learn representations from raw data.",
   title_html="Deep <span class='g'>Learning</span>",
   tags=["Neural Nets","Backprop","Activations","Optimizers","CNN","RNN / LSTM","Batch Norm","Dropout"]),
 dict(n=21, file="AI-ML/04-transformers-and-llms.md", out="AI-ML/Transformers-and-LLMs-Magazine.pdf",
   name="Transformers & LLMs", acc="#8b5cf6", acc2="#a855f7",
   sub="Attention, the Transformer, tokenization, RLHF and LoRA — the architecture behind modern AI.",
   title_html="Transformers &amp; <span class='g'>LLMs</span>",
   tags=["Self-Attention","Transformer","BERT vs GPT","Tokenization","RLHF","LoRA","Quantization","MoE"]),
 dict(n=22, file="AI-ML/05-llm-applications-genai.md", out="AI-ML/LLM-Applications-Magazine.pdf",
   name="LLM Applications & GenAI", acc="#14b8a6", acc2="#10b981",
   sub="Prompting, RAG, embeddings, vector search and agents — building real products on top of LLMs.",
   title_html="LLM Applications &amp; <span class='g'>GenAI</span>",
   tags=["Prompt Engineering","RAG","Embeddings","Vector DBs","Agents","Function Calling","Eval","Guardrails"]),
 dict(n=23, file="AI-ML/06-mlops-and-ml-system-design.md", out="AI-ML/MLOps-ML-System-Design-Magazine.pdf",
   name="MLOps & ML System Design", acc="#f59e0b", acc2="#f97316",
   sub="Feature stores, distributed training, serving, drift and the ML system-design playbook (recsys, CTR, ranking).",
   title_html="MLOps &amp; ML <span class='g'>System Design</span>",
   tags=["MLOps Lifecycle","Feature Store","Distributed Training","Serving","Drift","Recsys","CTR","Two-Tower"]),
]
